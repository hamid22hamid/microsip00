...
enum EUserWndMessages
{
	...
	IDT_TIMER_PROGRESS,
	IDT_TIMER_DTMF,
	IDT_TIMER_LICENSE,  // [IVR_ADDON] Verification licence
	IDT_TIMER_IVR_POLL, // [IVR_ADDON] Polling commandes panel → MicroSIP (1s)
	IDT_TIMER_CUSTOM,
	UM_CLOSETAB,
	UM_DBLCLICKTAB,
	UM_QUERYTAB,
	UM_UPDATE_CHECKER_LOADED,
	UM_IVR_AUDIO_DONE,        // [IVR_ADDON]
	UM_IVR_NEXT_STEP,         // [IVR_ADDON]
